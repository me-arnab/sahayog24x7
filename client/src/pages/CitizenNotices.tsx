...
function safeFormatDate(dateString: string | undefined, options: Intl.DateTimeFormatOptions): string {
        ...
        <div className="flex items-center justify-between gap-4 max-md:flex-col max-md:items-start">
          <div>
            ...
            <p className="text-sm text-text-muted mt-1">
              Stay updated with the latest notices from your electricity board.
            </p>
          </div>
          <button
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 text-xs text-text-muted mb-3 flex-wrap">
                      <span>
                        ...
                        {safeFormatDate(notice.startDate, {
                          day: "numeric",
                          month: "short",
                          year: "numeric",
                        })}{" "}
                        —{" "}
                        {safeFormatDate(notice.endDate, {
                          day: "numeric",
                          month: "short",
                          year: "numeric",
                        })}
          ...
          >
            ...
            <div className="p-6 space-y-4 text-sm">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-navy">
                    {safeFormatDate(selectedNotice.startDate, {
                      day: "numeric",
                      month: "long",
                      year: "numeric",
                    })}
                ...
                <div>
                  ...
                  <p className="font-semibold text-navy">
                    {safeFormatDate(selectedNotice.endDate, {
                      day: "numeric",
                      month: "long",
                      year: "numeric",
                    })}
              ...
              <p className="text-xs text-text-muted">
                Posted:{" "}
                {safeFormatDate(selectedNotice.createdAt, {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                  hour: "2-digit",
