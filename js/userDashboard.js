...
let allComplaints = [
            ...
            if (complaintForm) {
                complaintForm.addEventListener('submit', function(e) {
                    ...
                    setTimeout(() => {
                        ...
                        this.reset();
                        showNotification(`✅ New complaint ${formData.id} submitted! Now visible in Admin Dashboard 👨‍💼`);
                ...
                return `
                    <div class="complaint-card ${resolvedClass} ${newClass}" onclick="openComplaintModal('${complaint.id}')">
                        ...
                        <div class="action-buttons">
                            <button class="action-btn" onclick="event.stopPropagation(); openComplaintModal('${complaint.id}')">👁️ View</button>
                            ${complaint.status !== 'resolved' ? `<button class="action-btn" onclick="event.stopPropagation(); assignTeam('${complaint.id}')">📞 Assign</button>` : ''}
                        </div>
                    </div>
                `;
            }).join('');
        ...
        function openComplaintModal(complaintId) {
            ...
            // ✅ DYNAMIC BUTTONS: Hide actions for resolved complaints
            ...
            if (selectedComplaint.status === 'resolved') {
                ...
                modalActions.innerHTML = `
                    ...
                    <button class="action-btn" onclick="assignTeam()">👥 Assign Team</button>
                `;
            }
